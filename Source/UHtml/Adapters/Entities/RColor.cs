...
namespace UHtml.Adapters.Entities
{
    ...
    /// Need to implement a HSL/HSLA <=> RGBA conversions?
    /// Need to implement hexadecimal color code conversions?
    /// </summary>
    public struct RColor
    {
        ...
        public static RColor FromArgb(int alpha, int red, int green, int blue)
        {
            ...
            //Makes this unique RGB color combination and Alpha (opacity) a 64-bit unique long using bitwise operations
