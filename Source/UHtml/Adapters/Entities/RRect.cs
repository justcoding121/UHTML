...
namespace UHtml.Adapters.Entities
{
    ...
    public struct RRect
    {
        ...
        /// </returns>
        /// <param name="x1">The x-coordinate of the upper-left corner of the rectangular region. </param>
        /// <param name="y1">The y-coordinate of the upper-left corner of the rectangular region. </param>
        /// <param name="x2">The x-coordinate of the lower-right corner of the rectangular region. </param>
        /// <param name="y2">The y-coordinate of the lower-right corner of the rectangular region. </param>
        public static RRect FromCoordinates(double x1, double y1, double x2, double y2)
        {
        ...
        /// <summary>
        ///     Inflates this <see cref="RRect" /> structure by the specified amount in in all directions from (X,Y)
        /// </summary>
        /// <param name="x">
        ...
        /// <summary>
        ///     Inflates this <see cref="RRect" /> by the specified amount in all directions from (X,Y) 
        /// </summary>
        ...
        /// <summary>
        ///     Returns a <see cref="RRect" /> structure that represents the intersection of two rectangles. If there is no intersection, an empty
        ///     <see
        ///         cref="RRect" />
        ///     is returned.
        /// </summary>
